...
<head>
    ...
    <title>Pendaftaran | {{ $identitas->nama_app }}</title>
...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        <div class="login-logo">
            <a href="masuk"><b>{{ $identitas->nama_app }}
            </b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body" style="border-radius: 10px;">
            ...
            <form name="formLogin" action="{{ route('register.post') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <a href="{{ route('login') }}" class="btn btn-block btn-success btn-flat">
                            <i class="fa fa-sign-in"></i> Sudah mempunyai akun ? Masuk
                        </a>
